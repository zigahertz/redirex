defmodule RedirexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RedirexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RedirexWeb.Gettext, "errors", msg, opts)
    end
  end
